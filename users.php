                        ...
                        <div class="box-body">
                            <table id="userTable" class="table table-bordered table-striped">
                                ...
                                <tr role="row" class="odd">
                                    <td class="sorting_1">mamun</td>
                                    <td>mamunzet@gmail.com</td>
                                    <td>Mamun Rashed</td>
                                    <td>01722945055</td>
                                    <td>Editor</td>
                                    ...
                                    <td>
                                        <a href="http://localhost/stock/users/edit/2" class="btn btn-default"><i class="fa fa-edit"></i></a>
                                        <a href="http://localhost/stock/users/delete/2" class="btn btn-default"><i class="fa fa-trash"></i></a>
                                    </td>
                                </tr>

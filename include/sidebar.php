        ...
        <ul class="sidebar-menu tree" data-widget="tree">
            ...
            <!--<li class="treeview" id="mainUserNav">
                ...
                <ul class="treeview-menu">
                    <li id="createUserNav"><a href="add_user.php"><i class="fa fa-circle-o"></i> Add User</a></li>

                    <li id="manageUserNav"><a href="users.php"><i class="fa fa-circle-o"></i>Manage Users</a></li>
                </ul>
            </li>
            ...
            <li class="treeview" id="mainGroupNav">
                ...
                <ul class="treeview-menu">
                    <li id="addGroupNav"><a href="add_group.php"><i
            ...
            <li class="treeview" id="mainProductNav">
                ...
                <ul class="treeview-menu">
                    <li id="addProductNav"><a href="add_product.php"><i
                                class="fa fa-circle-o"></i> Add Product</a></li>
                    <li id="manageProductNav"><a href="products.php"><i
            ...
            <li class="treeview" id="mainOrdersNav">
                ...
                <ul class="treeview-menu">
                    <li id="addOrderNav"><a href="add_order.php"><i
                                class="fa fa-circle-o"></i> Add Order</a></li>
                    <li id="manageOrdersNav"><a href="orders.php"><i class="fa fa-circle-o"></i>
                            Manage Orders</a></li>
                </ul>
            </li>

            <!-- <li id="reportNav">
                <a href="http://localhostreports.php">
                    <i class="glyphicon glyphicon-stats"></i> <span>Reports</span>
                </a>
            </li> -->


            <li id="companyNav"><a href="company.php"><i class="fa fa-files-o"></i> <span>Company</span></a>
            </li>
